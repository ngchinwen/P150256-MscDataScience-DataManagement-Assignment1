...
```bash
hdfs dfs -put /path/to/yelp_academic_dataset_business.json hdfs:///user/maria_dev/yelp/
hdfs dfs -put /path/to/yelp_academic_dataset_reviews.json hdfs:///user/maria_dev/yelp/
```
